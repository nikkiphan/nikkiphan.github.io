...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({startPosition:0},0).to({scaleX:0.7143,scaleY:0.7143,y:470.3},3).to({scaleX:0.8743,scaleY:1.1428,y:410},7,cjs.Ease.quintOut).to({scaleX:0.7143,scaleY:0.7143,y:470.3},7,cjs.Ease.cubicIn).to({scaleX:1,scaleY:1,y:465},4,cjs.Ease.quintOut).wait(2));
...
// library properties:
lib.properties = {
	id: 'E1729145FBAF4563951BA3009C0873CC',
	width: 800,
	height: 600,
	fps: 24,
	color: "#E2AB84",
...
an.compositions['E1729145FBAF4563951BA3009C0873CC'] = {
